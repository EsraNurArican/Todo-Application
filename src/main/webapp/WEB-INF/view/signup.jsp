...
<body class="text-center">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="col-md-12">
          <h1> Welcome To Esra Nur's Todo App!</h1>
        </div>
        <div class="col-md-12">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9n1x2VtfmruJMWFhhnprJ2FK_0GaOURIYsg&usqp=CAU" alt="logo" style="width:500px;height:500px;">
        </div>
      </div>
      <div class="col-md-6">
        <form class="form-signin" action="processSignup" method="post">
          ...
          <a class="btn btn-lg btn-success btn-block" href="/login">Log in</a>
        </form>
      </div>
    </div>
  </div>
